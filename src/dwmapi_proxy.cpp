...
#pragma comment(linker, "/EXPORT:DwmInvalidateIconicBitmaps=DWMAPI.DwmInvalidateIconicBitmaps,@146")
#pragma comment(linker, "/EXPORT:#147=DWMAPI.#147,@147,NONAME")
#pragma comment(linker, "/EXPORT:#148=DWMAPI.#148,@148,NONAME")
#pragma comment(linker, "/EXPORT:DwmIsCompositionEnabled=DWMAPI.DwmIsCompositionEnabled,@149")
...
#pragma comment(linker, "/EXPORT:#188=DWMAPI.#188,@188,NONAME")
#pragma comment(linker, "/EXPORT:#189=DWMAPI.#189,@189,NONAME")
#pragma comment(linker, "/EXPORT:#190=DWMAPI.#190,@190,NONAME")
#pragma comment(linker, "/EXPORT:#191=DWMAPI.#191,@191,NONAME")
#pragma comment(linker, "/EXPORT:#192=DWMAPI.#192,@192,NONAME")
#pragma comment(linker, "/EXPORT:#193=DWMAPI.#193,@193,NONAME")
#pragma comment(linker, "/EXPORT:#194=DWMAPI.#194,@194,NONAME")
#pragma comment(linker, "/EXPORT:#195=DWMAPI.#195,@195,NONAME")
#pragma comment(linker, "/EXPORT:#196=DWMAPI.#196,@196,NONAME")
#pragma comment(linker, "/EXPORT:#197=DWMAPI.#197,@197,NONAME")
#pragma comment(linker, "/EXPORT:#198=DWMAPI.#198,@198,NONAME")
#pragma comment(linker, "/EXPORT:DwmModifyPreviousDxFrameDuration=DWMAPI.DwmModifyPreviousDxFrameDuration,@199")
#pragma comment(linker, "/EXPORT:DwmQueryThumbnailSourceSize=DWMAPI.DwmQueryThumbnailSourceSize,@200")
#pragma comment(linker, "/EXPORT:DwmRegisterThumbnail=DWMAPI.DwmRegisterThumbnail,@201")
#pragma comment(linker, "/EXPORT:DwmRenderGesture=DWMAPI.DwmRenderGesture,@202")
#pragma comment(linker, "/EXPORT:DwmSetDxFrameDuration=DWMAPI.DwmSetDxFrameDuration,@203")
#pragma comment(linker, "/EXPORT:DwmSetIconicLivePreviewBitmap=DWMAPI.DwmSetIconicLivePreviewBitmap,@204")
#pragma comment(linker, "/EXPORT:DwmSetIconicThumbnail=DWMAPI.DwmSetIconicThumbnail,@205")
#pragma comment(linker, "/EXPORT:DwmSetPresentParameters=DWMAPI.DwmSetPresentParameters,@206")
#pragma comment(linker, "/EXPORT:DwmSetWindowAttribute=DWMAPI.DwmSetWindowAttribute,@207")
#pragma comment(linker, "/EXPORT:DwmShowContact=DWMAPI.DwmShowContact,@208")
#pragma comment(linker, "/EXPORT:DwmTetherContact=DWMAPI.DwmTetherContact,@209")
#pragma comment(linker, "/EXPORT:DwmTransitionOwnedWindow=DWMAPI.DwmTransitionOwnedWindow,@210")
#pragma comment(linker, "/EXPORT:DwmUnregisterThumbnail=DWMAPI.DwmUnregisterThumbnail,@211")
#pragma comment(linker, "/EXPORT:DwmUpdateThumbnailProperties=DWMAPI.DwmUpdateThumbnailProperties,@212")